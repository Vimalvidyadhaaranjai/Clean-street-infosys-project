    ...
    return (
        <nav className=' mx-auto bg-gray-200/60 px-20 w-full h-18 fixed top-0 z-15 backdrop-blur-2xl flex justify-between '>
            ...
            <div className='flex items-center gap-4 '>
                <button className='  border-1 border-white px-4 py-2 rounded-xl bg-gradient-to-r from-[#ffffff] to-[#dad4d4]'>Login</button>
                <button className='bg-gradient-to-r from-[#14213D] to-[#4695d9] text-white px-4 py-2 rounded-xl'>Register</button>
            </div>
        </nav>
    )
}
